...
def parse_args(default=False):
    ...
    ##### AYA Project Configurations #####
    parser.add_argument('--single_device', default=0, type=int, help='The GPU number for training in single-GPU setting')
    parser.add_argument('--ratio_known_normal', default=0, type=float, help='Known ratio for normal data')
    parser.add_argument('--ratio_known_outlier', default=0, type=float, help='Known ratio for outlier data')
    ...
    parser.add_argument('--ratio_pollution', default=0.0, type=float, help='Ratio for polluted')
